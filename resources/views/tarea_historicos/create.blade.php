    ...
    @include('error')
        ...
        <div class="row">
            <div class="columnaPrincipal col-md-6" >
                <div class="row">
                    <div class="col-md-12">
                         <div class="page-header"><h2><i class="glyphicon glyphicon-plus"></i> Crear Tarea Histórico</h2></div>
             ...
             <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12">
                       <div class="page-header"><h2><i class="glyphicon glyphicon-eye-open"></i>Tareas ingresadas</h2></div> 
